...
if apply_channel:
    if thermal_noise:
        save_name = "datasets/RML2016.10a_dict.dat"
    else:
        save_name = "datasets/RML2016.10a_clean_dict.dat"
else:
    save_name = "datasets/RML2016.10a_debug_dict.dat"
pickle.dump(dataset, open(save_name, "wb"))
